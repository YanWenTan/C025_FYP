...
#include "robotiq_3f_gripper_ros2_interfaces/msg/detail/robotiq3_f_gripper_output_registers__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robotiq_3f_gripper_ros2_interfaces::msg::Robotiq3FGripperOutputRegisters & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robotiq_3f_gripper_ros2_interfaces::msg::Robotiq3FGripperOutputRegisters & ros_message)
{
  // Member: r_act
  cdr >> ros_message.r_act;
...
{
  auto typed_message =
    static_cast<const robotiq_3f_gripper_ros2_interfaces::msg::Robotiq3FGripperOutputRegisters *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robotiq_3f_gripper_ros2_interfaces::msg::Robotiq3FGripperOutputRegisters *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Robotiq3FGripperOutputRegisters__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const robotiq_3f_gripper_ros2_interfaces::msg::Robotiq3FGripperOutputRegisters *>(
...
static size_t _Robotiq3FGripperOutputRegisters__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Robotiq3FGripperOutputRegisters(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Robotiq3FGripperOutputRegisters__callbacks = {
...
static rosidl_message_type_support_t _Robotiq3FGripperOutputRegisters__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Robotiq3FGripperOutputRegisters__callbacks,
...
{
  return &robotiq_3f_gripper_ros2_interfaces::msg::typesupport_fastrtps_cpp::_Robotiq3FGripperOutputRegisters__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robotiq_3f_gripper_ros2_interfaces, msg, Robotiq3FGripperOutputRegisters)() {
  return &robotiq_3f_gripper_ros2_interfaces::msg::typesupport_fastrtps_cpp::_Robotiq3FGripperOutputRegisters__handle;
}
